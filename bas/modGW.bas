...
Function Groupwise_Mail(ByRef myRecipients() As String, _
                        ByRef myAttachments() As String, _
                        ByVal mySubject As String, _
                        ByVal myBodytext As String, _
                        ByRef ClientMessageId As String, _
                        ByRef DeliveredDate As Date, _
               Optional ByRef ccRecipients As Variant, _
               Optional ByRef bccRecipients As Variant)
